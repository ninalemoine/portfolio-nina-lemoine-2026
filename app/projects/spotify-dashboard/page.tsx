      ...
      <div className="container mx-auto px-4 md:px-20 py-20 flex flex-col md:flex-row gap-20">
        <div className="w-full md:w-2/3 space-y-12">
            ...
            <section>
                ...
                <div className="p-8 border-l-4 border-green-500 bg-zinc-900/30 rounded-r-xl">
                    <p className="text-lg text-zinc-300 italic">
                        "Gérer l'authentification OAuth 2.0 de Spotify dans un environnement serverless (Apps Script) et orchestrer les appels API pour éviter les quotas, tout en intégrant les réponses de l'IA en temps réel."
                    </p>
                </div>
            </section>
            ...
            <div className="w-full aspect-video rounded-xl overflow-hidden border border-zinc-700 shadow-2xl">
                <img 
                    src="/detail-spotify.jpg" 
                    alt="Dashboard Spotify Gemini" 
